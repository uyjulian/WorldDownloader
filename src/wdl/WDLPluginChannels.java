...
public class WDLPluginChannels {
	...
	public static void sendRequests() {
		...
		Minecraft.getMinecraft().getConnection().getNetworkManager().sendPacket(requestPacket);
	}
	...
	static void onWorldLoad() {
		...
		minecraft.getConnection().getNetworkManager().sendPacket(registerPacket);
		...
		minecraft.getConnection().getNetworkManager().sendPacket(initPacket);
	}
