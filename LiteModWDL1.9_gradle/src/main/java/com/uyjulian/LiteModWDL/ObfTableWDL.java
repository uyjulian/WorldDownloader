...
public class ObfTableWDL extends Obf {
	public static ObfTableWDL NetHandlerPlayClient = new ObfTableWDL("net/minecraft/client/network/NetHandlerPlayClient","bks");
	public static ObfTableWDL WorldClient = new ObfTableWDL("net/minecraft/client/multiplayer/WorldClient","bku");
	public static ObfTableWDL GuiIngameMenu = new ObfTableWDL("net/minecraft/client/gui/GuiIngameMenu","bex");
	
	public static ObfTableWDL GuiButton = new ObfTableWDL("net/minecraft/client/gui/GuiButton","bcz");
	...
	public static ObfTableWDL S40PacketDisconnect = new ObfTableWDL("net/minecraft/network/play/server/SPacketDisconnect","gj");
	public static ObfTableWDL IChatComponent = new ObfTableWDL("net/minecraft/util/text/ITextComponent","eu");
	public static ObfTableWDL S02PacketChat = new ObfTableWDL("net/minecraft/network/play/server/SPacketChat","fy");
	public static ObfTableWDL BlockPos = new ObfTableWDL("net/minecraft/util/math/BlockPos","cj");
	public static ObfTableWDL S24PacketBlockAction = new ObfTableWDL("net/minecraft/network/play/server/SPacketBlockAction","ft");
	public static ObfTableWDL S34PacketMaps = new ObfTableWDL("net/minecraft/network/play/server/SPacketMaps","gt");
	public static ObfTableWDL S3FPacketCustomPayload = new ObfTableWDL("net/minecraft/network/play/server/SPacketCustomPayload","gh");
