...
public class ObfTableWDL extends Obf {
	public static ObfTableWDL NetHandlerPlayClient = new ObfTableWDL("net/minecraft/client/network/NetHandlerPlayClient","bcy");
	public static ObfTableWDL WorldClient = new ObfTableWDL("net/minecraft/client/multiplayer/WorldClient","bdb");
	public static ObfTableWDL GuiIngameMenu = new ObfTableWDL("net/minecraft/client/gui/GuiIngameMenu","axp");
	
	public static ObfTableWDL GuiButton = new ObfTableWDL("net/minecraft/client/gui/GuiButton","avs");
	public static ObfTableWDL Entity = new ObfTableWDL("net/minecraft/entity/Entity","pk");
	public static ObfTableWDL Block = new ObfTableWDL("net/minecraft/block/Block","afh");
	public static ObfTableWDL S40PacketDisconnect = new ObfTableWDL("net/minecraft/network/play/server/S40PacketDisconnect","gh");
	public static ObfTableWDL IChatComponent = new ObfTableWDL("net/minecraft/util/IChatComponent","eu");
	public static ObfTableWDL S02PacketChat = new ObfTableWDL("net/minecraft/network/play/server/S02PacketChat","fy");
	public static ObfTableWDL BlockPos = new ObfTableWDL("net/minecraft/util/BlockPos","cj");
	public static ObfTableWDL S24PacketBlockAction = new ObfTableWDL("net/minecraft/network/play/server/S24PacketBlockAction","fu");
	public static ObfTableWDL S34PacketMaps = new ObfTableWDL("net/minecraft/network/play/server/S34PacketMaps","gu");
	public static ObfTableWDL S3FPacketCustomPayload = new ObfTableWDL("net/minecraft/network/play/server/S3FPacketCustomPayload","gg");
